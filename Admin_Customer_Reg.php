...
include 'Admin_CustomerReg_Process.php';
...
<body>
	...
	<div class="wrapper">
        ...
        <div class="panel-header">
            ...
            <form action="Admin_CustomerReg_Process.php" method="POST">
                                    ...
                                    <div class="row" >
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" name="empid" id="empid" value="<?php echo $empid; ?>">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                    <input type="date" id="RegDate" name="RegDate" required class="form-control"  value="<?php echo $RegDate; ?>" >
                                                    <br>
                                                    </div>
...
$i = 1;
        ...
        <td><?php echo $row["RegDate"]; ?></td>
            ...
            <td>
            <a href="Admin_Customer_Reg.php?edit=<?php echo $row["empid"]; ?> " class="btn btn-primary"> Edit</a>
            <a href="Admin_CustomerReg_Process.php?delete=<?php echo $row["empid"]; ?>" onclick="return  confirm('do you want to delete Y/N')" class="btn btn-danger"> Delete</a>
            </td>
